...
import app.AppState
import app.Configuration.IsValid
import cats.data.{NonEmptyChain, State}
import cats.implicits._
import common.IO
import common.IO.{Done, FlatMap, More}
import model._
import org.scalacheck.{Arbitrary, Gen}
import service.ExpenseService.{ExpenseOp, ExpenseState}
import service.PersonService.{PersonOp, PersonState}
